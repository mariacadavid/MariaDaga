...
To run the program you must have all the scripts (here provided), the SQL database to fill (zip here provided) and your own directory with the genebank (.gbff) files of interest. 
